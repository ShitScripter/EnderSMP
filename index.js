...
bot.on('message', msg => {
    if (msg.content === "e!rules") {
        msg.reply('```css -Discord Rules | Breaking any of these rules will result in an immediate ban \n \n !➼ No Harassment. This includes Sexist, Racial, Homophobic or just generally rude comments towards any player \n \n !➼ No NSFW. Keep the channel PG \n \n !➼ No Cursing. \n \n !➼ No Controversial or triggering topics. Including suicide, self-harm, substance abuse, sexual content, etc. \n \n !➼ No advertising of any kind (This includes dm advertising) \n \n !➼ Use the channels appropriately \n \n !➼ Staff decisions are final \n \n !➼ Use Common Sense \n \n \n !➼ All Discord Terms of Service (https://discordapp.com/terms) apply. \n \n    *Breaking any of these will result in a permanent ban from the server. (This includes DM Advertising) If you witness any of these \n        terms being broken, please report them to a server Staff Member immediately.* \n \n -Server Rules | All Previous rules Apply! \n \n !➼ No Cheating/Hacking. This includes but is not limited to injecting cheats into PVP clients, Xray texture packs, ghost clients. \n (PVP Clients are OK) \n \n !➼ No abusing Glitches/Exploits. If you are caught doing so you will be permanently banned. Please report these glitches to the \n       staff members IMMEDIATELY. \n !➼ Schematica is OK but printer is not. \n ```');
    }
});
